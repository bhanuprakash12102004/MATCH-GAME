...
class App extends Component {
  ...
  render() {
    ...
    const getDisplayedImages = filteredImages.filter(
      each => each.category === activeTabId,
    )

    const imageUrllist = imagesList.find(each => each.id === displayedImageid)
        ...
        {!isGameOver ? (
          <div className="bottom-container">
            <img
              ...
              src={imageUrllist.imageUrl}
            />
            <ul className="category-container">
              <li>
                <button
                  onClick={this.changeToFruitCategory}
                  className={`category-button ${
                    activeTabId === 'FRUIT' ? 'active' : ''
                  }`}
                >
                  Fruits
                </button>
              ...
              <li>
                <button
                  onClick={this.changeToAnimalsCategory}
                  className={`category-button ${
                    activeTabId === 'ANIMAL' ? 'active' : ''
                  }`}
                >
                  Animals
                </button>
              ...
              <li>
                <button
                  onClick={this.changeToPlacesCategory}
                  className={`category-button ${
                    activeTabId === 'PLACE' ? 'active' : ''
                  }`}
                >
                  Places
                </button>
          ...
          <div className="bottom-container1">
            <div className="result-card">
              ...
              <button onClick={this.playAgain} className="play-again-btn">
                <img
